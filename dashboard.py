...
with tab2:
    ...
    st.header('Kesimpulan')
    st.write('Pelanggan lebih banyak yang menyukai bersepeda disaat cuaca panas dibandingkan saat cuaca dingin, hal ini berkorelasi juga dengan musim yang ada.')
